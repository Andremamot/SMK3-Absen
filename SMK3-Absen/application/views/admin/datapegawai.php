    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="addpegawaimodallabel"><span class="fas fa-user-plus mr-1"></span>Tambah Guru</h5>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label for="shift_pegawai" class="col-sm-4 col-form-label">Golongan</label>
                    <div class="col-sm-8">
                        <div class="form-check form-check-inline">
